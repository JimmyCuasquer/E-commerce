...
const Pay = () => {
    ...
    return (
        <>
        {state.cart.length > 0 ? <div className="container"> <Tienda/> <form action="#" class="credit-card-div">
       <h2>Pago con tarjeta de Credito</h2>
        ...
        <div class="col-md-12 pad-adjust">
            <div class="checkbox">
            <label>
            <input type="checkbox" checked /> Save details for fast payments 
            <a href="#home"> learn how ?</a>
            </label>
        </div>
        </div>
            </div>
   ...
   </form></div>  : <h2 className="text">Ve al inicio y agrega articulos a tu carrito para pagar !</h2>} 
   </>
    )
}
